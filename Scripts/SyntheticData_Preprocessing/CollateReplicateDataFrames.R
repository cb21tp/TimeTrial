...
write.csv(x = data, file = "../../Data/Raw/Concate/Con_NoiseLV_0_BioRep_1.csv")
write.csv(x = merge2Reps(data,data1), file = "../../Data/Raw/Concate/Con_NoiseLV_0_BioRep_2.csv")
write.csv(x = merge3Reps(data,data1,data2) ,file = "../../Data/Raw/Concate/Con_NoiseLV_0_BioRep_3.csv")
...
write.csv(x = data3, file = "../../Data/Raw/Concate/Con_NoiseLV_0.1_BioRep_1.csv")
write.csv(x = merge2Reps(data3,data4), file = "../../Data/Raw/Concate/Con_NoiseLV_0.1_BioRep_2.csv")
write.csv(x = merge3Reps(data3,data4,data5) ,file = "../../Data/Raw/Concate/Con_NoiseLV_0.1_BioRep_3.csv")
...
write.csv(x = data6, file = "../../Data/Raw/Concate/Con_NoiseLV_0.2_BioRep_1.csv")
write.csv(x = merge2Reps(data6,data7), file = "../../Data/Raw/Concate/Con_NoiseLV_0.2_BioRep_2.csv")
write.csv(x = merge3Reps(data6,data7,data8) ,file = "../../Data/Raw/Concate/Con_NoiseLV_0.2_BioRep_3.csv")
...
write.csv(x = data9, file = "../../Data/Raw/Concate/Con_NoiseLV_0.3_BioRep_1.csv")
write.csv(x = merge2Reps(data9,data10), file = "../../Data/Raw/Concate/Con_NoiseLV_0.3_BioRep_2.csv")
write.csv(x = merge3Reps(data9,data10,data11) ,file = "../../Data/Raw/Concate/Con_NoiseLV_0.3_BioRep_3.csv")
...
write.csv(x = data12, file = "../../Data/Raw/Concate/Con_NoiseLV_0.4_BioRep_1.csv")
write.csv(x = merge2Reps(data12,data13), file = "../../Data/Raw/Concate/Con_NoiseLV_0.4_BioRep_2.csv")
write.csv(x = merge3Reps(data12,data13,data14) ,file = "../../Data/Raw/Concate/Con_NoiseLV_0.4_BioRep_3.csv")
