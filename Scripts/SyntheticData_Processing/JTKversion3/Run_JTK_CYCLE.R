...
project <- args[1]
#"2_24_NoiseLV_0_BioRep_2.txt"

options(stringsAsFactors=FALSE)
data <- read.delim(args[2])
#data <- read.delim("~/Desktop/CyclingMethodsReview/DataAnalysis/Data/Processed/JTK/Concat_Experiments/2_24_NoiseLV_0_BioRep_2.txt")
annot <- data[,1]
